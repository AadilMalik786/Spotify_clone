    ...
    return (
      <>
        ...
        <section className="ajju" style={{ height: "100vh", width: "100%", backgroundColor: "black",overflow:"hidden" }}>
          <div className="parent" style={{ display: "flex", justifyContent: "space-evenly",overflow:"hidden"}}>
            ...
            <article className="child" style={{ position: "relative", overflow: 'hidden', width: "300%", height: "90vh", display: "flex", flexDirection: "column", justifyContent: "space-evenly",overflow:"hidden" }}>
